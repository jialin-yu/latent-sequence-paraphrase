...
class TransformerDecoder(nn.Module):
    ...
    def decode(self, trg_emb, src_memory, trg_m=None, trg_src_m=None, trg_pm=None, src_memory_pm=None):
        '''
        INPUT: 
        ...
        return self.linear(self.decoder(trg_emb, src_memory, trg_m, trg_src_m, trg_pm, src_memory_pm))
